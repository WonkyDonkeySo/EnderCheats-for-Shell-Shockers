// ==UserScript==
// @name         Ender Cheats Shell Shockers
...
(function () {
                    ...
                    <div class="media-tab-container display-grid align-items-center gap-sm bg_blue3">
                        <h4 class="common-box-shadow text-shadow-black-40 text_white dynamic-text" style="display: flex; align-items: center;">
                            <div class="dynamic-text" style="width: 10em; font-size: 1em;">
                                <div class="dynamic-text" style="font-size: 1em;">Ender Updates</div>
                            </div>
            ...
            Object.keys(bindsArray).forEach(function (module) {
                if ((bindsArray[module] == event) && module != "zoom") {
                    ...
                    if (state != "NOMSG") {
                        ...
                        switch (module) {
                            case ("hide"):
                                popupText = "Toggled Ender Panel"; break;
                            case ("showBotPanel"):
    ...
    const initMenu = function (reset) {
        ...
        //SFC CHAT
        initFolder({ location: tp.mainPanel, title: "Ender Cheats BIO", storeAs: "sfChatFolder", });
...
`Sorry! No guide yet!`},
        ...
        //COMBAT MODULES
        initFolder({ location: tp.mainPanel, title: "Aimbot and More", storeAs: "combatFolder", });
...
(...hence it is called... AntiSneak).`},
        ...
        //RENDER MODULES
        initFolder({ location: tp.mainPanel, title: "ESP and More", storeAs: "renderFolder", });
...
`Sorry! No guide yet!`},
        ...
        //CHAT MODULES
        initFolder({ location: tp.mainPanel, title: "Chats and more", storeAs: "chatFolder", });
...
`Sorry! No guide yet!`},
        ...
        //LISTS MODULES
        initFolder({ location: tp.mainPanel, title: "WhiteLists +", storeAs: "listsFolder", });
...
But check out the GitHub guide.`},
        ...
        //THEMING MODULES
        initFolder({ location: tp.mainPanel, title: "Customization", storeAs: "themingFolder", });
...
`Sorry! No guide yet!`},
            ...
            tp.miscTab.pages[0].addSeparator();
            initFolder({ location: tp.miscTab.pages[0], title: "Ender UI Options", storeAs: "sfcUIFolder", });
...
`;
    ...
    const everySecond = function () {
        ...
        if (isBanned && extract("autoUnban") && (!attemptedAutoUnban) && unsafeWindow.vueApp?.bannedPopup) {
            log("eep!");
            banPopup.textContent = 'EnderChats Unban:\nYou now have a new database\nID for unban. Enjoy! :)\nBan message will be automatically removed from screen in 20 seconds.';
            unban();
